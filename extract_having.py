...
def extract_having_part(parsed):
    '''generator function that extracts "having" part of a query, including any nested subqueries
...
def extract_having(sql):
    '''extracts having aggregate identifiers from a SQL statement.  does not validate that the SQL is correct
